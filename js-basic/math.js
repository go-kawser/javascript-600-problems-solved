...
const iHaveTotalRice = 480;
const everyDayEat = 4;
const oneMonth = 30;
const totalDays = iHaveTotalRice / everyDayEat;
console.log(totalDays);

const totalMonth = iHaveTotalRice / oneMonth;
